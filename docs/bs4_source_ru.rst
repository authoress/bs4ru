...
* ``UnicodeEncodeError: 'charmap' codec can't encode character
  ...
  вывести символ Unicode, который ваша консоль не знает, как
  отобразить. (Смотрите `эту страницу в Python вики
...
важнее  программистского времени, стоит забыть о Beautiful Soup
...
`Разбор части документа`_ не сэкономит много времени на разборе
документа, но может сэкономить много памяти, что сделает
`поиск` по документу намного быстрее.

Перевод этой документации
==============================

Перевод документации Beautiful Soup очень
приветствуется. Перевод должен быть лицензирован по лицензии MIT,
так же, как сам Beautiful Soup и англоязычная документация к нему.

Есть два способа передать ваш перевод в основную кодовую базу
и на веб-сайт Beautiful Soup:
...
2. Отправьте сообщение в дискуссионную группу Beautiful Soup со ссылкой на
   ваш перевод, или приложите ваш перевод к сообщению.
...
Вы также можете скачать `tar-архив Beautiful Soup 3.2.0
...
разобрать XML, вы передаете "xml" в качестве второго аргумента
